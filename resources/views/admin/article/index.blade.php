                        ...
                        <div class="widget-body  am-fr">
                            ...
                            <div class="am-u-sm-12 am-u-md-6 am-u-lg-3">
                                <div class="am-form-group tpl-table-list-select ">
                                    <select data-am-selected name="cate_id" style="color: black" placeholder="所有类别">
                                    ...
                                    <tr class="gradeX">
                                        ...
                                        <td>
                                            <div class="tpl-table-black-operation">
                                                <a href="javascript:;">
                                                    <form action="{{ route('article.edit', $g->id) }}" method="get">
                                                ...
                                                <a class="tpl-table-black-operation-del">
                                                    <form action="{{ route('article.destroy', $g->id) }}" method="post">
                                                        {{ csrf_field() }}
                                                        {{ method_field('DELETE') }}
