                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        ...
                        <div class="widget-body am-fr">
                            ...
                            <form method="post" action="{{route('users.update_avatar', $user->id)}}" class="am-form tpl-form-border-form tpl-form-border-br" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-1 am-form-label">头像 <span class="tpl-form-line-small-title">Avatar</span></label>
                                    <div class="am-u-sm-11">
                                        <figure class="image is-1by1"><img style="width: 500px;height: 500px;" src="{{asset($user->avatar)}}"></figure>
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-1 am-form-label">选择图片 <span class="tpl-form-line-small-title">pic</span></label>
                                    <div class="am-u-sm-11">
