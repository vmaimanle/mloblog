                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        ...
                        <div class="widget-body am-fr">
                            ...
                            <form method="post" action="{{route('category.store')}}" class="am-form tpl-form-border-form tpl-form-border-br">
                                {{ csrf_field() }}
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-1 am-form-label">标题 <span class="tpl-form-line-small-title">Title</span></label>
                                    <div class="am-u-sm-11">
                                        <input name="name" value="{{old('name')}}" type="text" class="tpl-form-input" id="user-name" placeholder="请输入标题">
                                    </div>
                                </div>
