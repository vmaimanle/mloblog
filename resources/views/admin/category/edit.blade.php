                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        ...
                        <div class="widget-body am-fr">
                            ...
                            <form method="post" action="{{route('category.update', $category->id)}}" class="am-form tpl-form-border-form tpl-form-border-br">
                                {{ csrf_field() }}
                                {{ method_field('PATCH') }}
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-1 am-form-label">名称 <span class="tpl-form-line-small-title">Title</span></label>
                                    <div class="am-u-sm-11">
                                        <input name="name" value="{{$category->name}}" type="text" class="tpl-form-input" id="user-name" placeholder="请输入标题">
                                    </div>
                                </div>

                                <div class="am-form-group">
                                    <label for="user-intro" class="am-u-sm-1 am-form-label">显示分类</label>
                                    <div class="am-u-sm-11">
                                        <div class="tpl-switch">
                                            <input name="is_show" type="checkbox" @if($category->status == 1) checked="" @endif class="ios-switch bigswitch tpl-switch-btn">
