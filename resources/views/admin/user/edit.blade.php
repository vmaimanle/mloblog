                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        ...
                        <div class="widget-body am-fr">
                            ...
                            <form method="post" action="{{route('users.update', $user->id)}}" class="am-form tpl-form-border-form tpl-form-border-br">
                                {{ csrf_field() }}
                                {{ method_field('PATCH') }}
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-1 am-form-label">名称 <span class="tpl-form-line-small-title">Title</span></label>
                                    <div class="am-u-sm-11">
                                        <input name="name" value="{{$user->name}}" type="text" class="tpl-form-input" id="user-name" placeholder="请输入标题">
                                    </div>
                                </div>

                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-1 am-form-label">邮箱 <span class="tpl-form-line-small-title">Email</span></label>
                                    <div class="am-u-sm-11">
                                        <input name="email" value="{{$user->email}}" type="text" class="tpl-form-input"  disabled>
                                    </div>
                                </div>

                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-1 am-form-label">密码 <span class="tpl-form-line-small-title">Password</span></label>
                                    <div class="am-u-sm-11">
                                        <input name="password" value="{{old('password')}}" type="password" class="tpl-form-input" >
                                    </div>
                                </div>

                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-1 am-form-label">确认密码 <span class="tpl-form-line-small-title">P_C</span></label>
                                    <div class="am-u-sm-11">
                                        <input name="password_confirmation" value="{{old('password_confirmation')}}" type="password" class="tpl-form-input" >
                                    </div>
                                </div>
